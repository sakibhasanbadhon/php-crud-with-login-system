    ...
    <!-- PAGE LEVEL PLUGINS-->
    <script src="public/assets/vendors/chart.js/dist/Chart.min.js" type="text/javascript"></script>
    <script src="public/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js" type="text/javascript"></script>
    <script src="public/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
    <script src="public/assets/vendors/jvectormap/jquery-jvectormap-us-aea-en.js" type="text/javascript"></script>
    <!-- CORE SCRIPTS-->
    <script src="public/assets/js/app.min.js" type="text/javascript"></script>
    <!-- PAGE LEVEL SCRIPTS-->
    <script src="public/assets/js/scripts/dashboard_1_demo.js" type="text/javascript"></script>
